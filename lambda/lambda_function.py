...
STREAMS = [
  {
    "token": '1',
    "url": 'https://azura.nexusradio-hosting.de/listen/altmuehltal-radio/stream',
    "metadata": {
      "title": 'Altmuehltal-Radio',
      "subtitle": 'Das Radio mit Musik und Herz',
      "art": {
        "sources": [
          {
            "contentDescription": 'example image',
            "url": 'https://altmuehltal-radio.de/templates/lh_tape/Banner_neu.gif?version=1746718847',
            "widthPixels": 1200,
            "heightPixels": 420
          }
        ]
